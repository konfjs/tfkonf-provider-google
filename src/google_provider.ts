...
export interface GoogleProviderArgsBatching {
  alias?: string;
...
export interface GoogleProviderArgs {
  ...
  add_terraform_attribution_label?: boolean;
  ...
  cloud_build_worker_pool_custom_endpoint?: string;
  ...
  default_labels?: { [key: string]: string };
  ...
  zone?: string;
  batching?: GoogleProviderArgsBatching;
}
