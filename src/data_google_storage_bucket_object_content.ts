...
export class data_google_storage_bucket_object_content extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: DataGoogleStorageBucketObjectContentArgs) {
    const meta = {};
