...
export class data_google_container_analysis_note_iam_policy extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: DataGoogleContainerAnalysisNoteIamPolicyArgs) {
    const meta = {};
