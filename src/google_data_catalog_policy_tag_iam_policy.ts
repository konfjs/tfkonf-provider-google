...
export class google_data_catalog_policy_tag_iam_policy extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: GoogleDataCatalogPolicyTagIamPolicyArgs) {
    const meta = {};
