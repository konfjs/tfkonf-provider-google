...
export class data_google_pubsub_schema_iam_policy extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: DataGooglePubsubSchemaIamPolicyArgs) {
    const meta = {};
